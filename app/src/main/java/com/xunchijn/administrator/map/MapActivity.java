...
import com.xunchijn.administrator.util.CheckPermissionsActivity;

/**
 * Created by Administrator on 2018/4/17 0017.
 */

public class MapActivity extends CheckPermissionsActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId())
        {
            case R.id.backtxt:
                ...
                data.putExtra("locStr",locString);
                data.putExtra("locLon",lon);
                data.putExtra("locLat",lat);
                setResult(LOCRESULT,data);
                Log.e("123",locString);
                finish();;
                break;
        }
