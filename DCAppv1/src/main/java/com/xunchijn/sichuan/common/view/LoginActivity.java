...
import com.xunchijn.sichuan.common.presenter.LoginContrast;
import com.xunchijn.sichuan.common.presenter.LoginPresenter;
...
public class LoginActivity extends AppCompatActivity implements LoginContrast.View, View.OnClickListener {
    ...
    private void initView() {
        ...
        TextView loginConfirm = findViewById(R.id.login_confirm);
    ...
    public void loginSuccess(String userName) {
        showError(String.format("%s，欢迎登录智慧环卫", userName));
