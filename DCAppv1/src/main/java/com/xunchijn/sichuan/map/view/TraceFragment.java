...
import com.xunchijn.sichuan.map.presenter.TraceContrast;
import com.xunchijn.sichuan.util.TimePickerDialog;
...
public class TraceFragment extends Fragment implements TraceContrast.View, View.OnClickListener {
    ...
    private void getTrace() {
        ...
        if (type.equals("人员")) {
            bitmap = BitmapDescriptorFactory.fromResource(R.mipmap.ic_trace_user);
