...
import com.xunchijn.sichuan.map.presenter.LocationContrast;
...
public class LocationFragment extends Fragment implements LocationContrast.View {
    ...
    private void showLocation(String name, String position) {
        ...
        OverlayOptions optionText = new TextOptions().position(llDot).text(name)
                .fontSize(24).fontColor(ContextCompat.getColor(getContext(), R.color.colorGreen));
