...
public class BaseConfig {
	...
	public static List<TitleItem> getMainTitles() {
		...
		SubTitleItem item6 = new SubTitleItem(7, "车辆报表", R.mipmap.ic_statistics);
		list.add(item);
		list.add(item1);
		list.add(item2);
		list.add(item6);
		...
		SubTitleItem item11 = new SubTitleItem(12, "人员报表", R.mipmap.ic_statistics);
		list1.add(item3);
		list1.add(item4);
		list1.add(item5);
		list1.add(item11);
		...
		SubTitleItem item9 = new SubTitleItem(10, "交流历史", R.mipmap.ic_report_history);
		SubTitleItem item10 = new SubTitleItem(11, "信息交流", R.mipmap.ic_report);
		list2.add(item7);
		list2.add(item8);
		list2.add(item9);
		list2.add(item10);
	...
	public static List<SettingItem> getInfo() {
		List<SettingItem> items = new ArrayList<>();
		SettingItem item1 = new SettingItem(0, "所在位置", "");
		SettingItem item2 = new SettingItem(1, "部门", "");
		items.add(item1);
	...
	public static List<SettingItem> getCarTable() {
		List<SettingItem> items = new ArrayList<>();
